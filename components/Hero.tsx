            ...
            <div className="flex items-center justify-center aspect-square relative rounded-xl overflow-hidden bg-purple-900/50">
              <div className="w-full h-full flex items-center justify-center relative">
                ...
                <div className="w-1/2 h-full overflow-hidden">
                  <img src="/base.jpg" alt="Original" className="w-full h-full object-cover" />
                </div>
                {/* Divider */}
                ...
                {/* Labels */}
                <div className="absolute bottom-2 left-4 bg-black/60 px-2 py-1 rounded text-xs text-white z-10">Original</div>
                <div className="absolute bottom-2 right-4 bg-black/60 px-2 py-1 rounded text-xs text-white z-10">Result</div>
